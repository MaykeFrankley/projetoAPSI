...
CREATE TABLE IF NOT EXISTS `siab`.`fichaB` (
  ...
  PRIMARY KEY (`municipio`, `area`, `microarea`, `codFamilia`),
  INDEX `fk_area_fichaB_idx` (`area` ASC) VISIBLE,
  INDEX `fk_microArea_fichaB_idx` (`microarea` ASC) VISIBLE,
  INDEX `fk_codFamilia_fichaB_idx` (`codFamilia` ASC) VISIBLE,
  CONSTRAINT `fk_municipio_fichaB`
    FOREIGN KEY (`municipio`)
    REFERENCES `siab`.`fichaA` (`municipio`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_area_fichaB`
    FOREIGN KEY (`area`)
    REFERENCES `siab`.`fichaA` (`area`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_microArea_fichaB`
    FOREIGN KEY (`microarea`)
    REFERENCES `siab`.`fichaA` (`microarea`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_codFamilia_fichaB`
    FOREIGN KEY (`codFamilia`)
    REFERENCES `siab`.`fichaA` (`codFamilia`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `siab`.`acompanhamento_H`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `siab`.`acompanhamento_H` (
  `municipio` INT NOT NULL,
  `area` INT NOT NULL,
  `microarea` INT NOT NULL,
  `codFamilia` INT NOT NULL,
  ...
  `dia_visita` INT NOT NULL DEFAULT 0,
  `faz_dieta` ENUM("Sim", "Não") NOT NULL DEFAULT 'Não',
  `toma_medicacao` ENUM("Sim", "Não") NOT NULL DEFAULT 'Não',
  `faz_exercicios_fisicos` ENUM("Sim", "Não") NOT NULL DEFAULT 'Não',
  `pressao_arterial` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`municipio`, `area`, `microarea`, `codFamilia`, `codMembro`, `mes`),
